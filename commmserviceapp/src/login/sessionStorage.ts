...
export const SESSION_LOGGED_IN_KEY = 'mmserviceapp_logged_in';
export const SESSION_REFRESH_TOKEN_KEY = 'mmserviceapp_refreshToken';
export const SESSION_USER_DATA_KEY = 'mmserviceapp_user_data';
