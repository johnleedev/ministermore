...
const INSTAGRAM_URL = 'https://www.instagram.com/mmserviceapp_';
      ...
      <ScrollView
        ...
        <View style={styles.section}>
          ...
          <Pressable
            ...
            accessibilityLabel="사역자모아 공식 인스타그램 mmserviceapp_">
            <View style={styles.instaAdv}>
              <View style={styles.instaAdvInner}>
                ...
                <View style={styles.instaTextCol}>
                  <Text style={styles.instaHandle}>mmserviceapp_</Text>
