...
const SERVICES = [
  ...
  },
  {
    ...
    strong: "모바일 행사 전단지",
    description:
      "임직식, 새신자 초청, 음악회 등 교회 행사 소식을 모바일에서 보기 좋게 홍보할 수 있는 안내 서비스입니다.",
    path: "/service/event",
  },
  {
    emoji: "⛰️",
    titleLines: ["수련회·집회", "안내 전단지"],
    strong: "수련회·집회 전단지",
    description:
      "수련회, 부흥회, 특별 집회·세미나 등 기간형 행사 안내와 참가 신청을 모바일 한 페이지로 정리할 수 있습니다.",
    path: "/service/retreat",
  },
  // {
  //   emoji: "🌐",
  //   titleLines: ["홈페이지 제작"],
