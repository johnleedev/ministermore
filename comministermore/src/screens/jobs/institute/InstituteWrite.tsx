...
export function InstituteWrite({ onBack, onSuccess }: Props) {
  ...
  const registerPost = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE}/recruitinstitute/postsrecruit`, formData, {
  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <Field label="기관명*" value={church} onChangeText={setChurch} />
        ...
        <Field label="대표/담당자" value={mainpastor} onChangeText={setMainpastor} />
