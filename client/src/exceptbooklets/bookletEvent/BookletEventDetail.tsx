...
import '../../screens/service/bookletEvent/createEvent/EventCreate.scss';
...
} from '../../screens/service/bookletEvent/createEvent/eventTemplateTypes';
...
function mainImageUrl(fileName: string): string {
  ...
  return `${MainURL}/images/bookletevent/mainimages/${safe}`;
}
...
export default function BookletEventDetail() {
  ...
  const fetchPosts = useCallback(async () => {
    ...
    try {
      const resBooklet = await axios.post(`${MainURL}/bookleteventmain/getdatabookletspart`, {
        id: ID,
      });
    ...
    try {
      ...
      const resProgram = await axios.post(`${MainURL}/bookleteventmain/getdataprogramspart`, {
        id: ID,
      });
    ...
    try {
      const resCast = await axios.post(`${MainURL}/bookleteventmain/getdatacastpart`, { id: ID });
    ...
    try {
      const resW = await axios.post(`${MainURL}/bookleteventmain/getdataworshippart`, { id: ID });
