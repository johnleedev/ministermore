...
const FAQ_ITEMS = [
  {
    q: "교회 모바일 예배안내를 함께 만들 수 있나요?",
    a: "네, 서비스 성격에 따라 교회 소개형, 주보형, 행사 안내형 구조로 맞춤 구성할 수 있습니다.",
  },
  {
    q: "주일학교 출석 관리도 모바일로 가능한가요?",
    a: "가능합니다. 부서별, 반별, 학생별 출석 현황을 보다 간편하게 관리할 수 있도록 설계할 수 있습니다.",
  },
  {
