...
import { applydocSubSort, applyhowSubSort, careerSubSort, hourSortOption, minuteSortOption, 
        ...
        sortSortOption, sortSubSort, SubTitleControl, weekdaySubSort } from './RecruitChurchPostData';
...
export default function RecruitChurchPost (props:any) {
  ...
  const registerPost = async () => {
    ...
    try {
      const res = await axios.post(`${MainURL}/recruitchurch/postsrecruit`, formData, {
        headers: {
