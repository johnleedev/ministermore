...
router.get('/eventsgetposts/:page', (req, res) =>
...
router.post('/eventsadminsetnotice', handleAdminNoticeSort({ db: boarddb, postsTable: 'eventsPosts' }));
router.post('/eventsadminmovepost', handleAdminMovePost({ db: boarddb }));
